...
#Begin modeling
wd<-"/home/rstudio/test/Modelos/04112016"
...
dist <- 1
n.bkg=10000
bias.raster<-raster("aves_avg.asc")
...
results<-read.csv("./04112016/results_summary.csv",as.is=T)

#Generate PNGs
bin.list<-results$tifPath[!is.na(results$thresholdType)|results$modelingMethod=="ch"]
bin.list<-sub("/home/rstudio/test/Modelos/04112016/","",bin.list)
